...
var geometry = new THREE.SphereGeometry(50, 50);
...
var texture = new THREE.TextureLoader().load('textures/brick_bump.jpg');
...
var texture = new THREE.TextureLoader().load('textures/transition4.png');

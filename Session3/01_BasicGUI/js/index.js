...
function init(){
  ...
  geometry1 = new THREE.DodecahedronGeometry(1, 1);
  geometry2 = new THREE.DodecahedronGeometry(1, 1);
  geometry3 = new THREE.DodecahedronGeometry(1, 1);
  geometry4 = new THREE.DodecahedronGeometry(1, 1);
  ...
  mesh3.position.set(-6, -6, -6);
  mesh3.rotation.set(1, 1, 1);
  ...
  mesh4.position.set(-12, -12, -12);
  mesh4.rotation.set(1, 1, 1);
